export const finishLoop = {
  name: "The Finish Loop",
  slug: "finish-loop",
  price: 49,
  currency: "USD",
  checkoutUrl:
  ...
  fit: [
    "You start strong but struggle to finish.",
    "You use AI but need standards and structure.",
    "You juggle projects and lose momentum at 90 percent.",
    "You want a finished body of work, not a larger prompt collection.",
  ],
  faqs: [
    {
    ...
    },
    {
      ...
      answer: "Yes. You receive the complete bundle immediately after purchase. The planner runs offline in a modern browser.",
    },
    {
    ...
    },
    {
      ...
      answer: "Book a 60-minute working session with Keith. Bring the real project and apply the system live.",
    },
  ],
};
