...
export const GET: APIRoute = () => {
  ...
  const noteSections = [...publishedNotes]
    ...
    .flatMap((note) => [
      ...
      "",
      note.directAnswer ?? note.summary,
      "",
  ...
  const body = [
    ...
    `Spotify artist record: ${site.social.spotify}`,
    `Apple Music artist record: ${site.social.appleMusic}`,
    `Amazon Music artist record: ${site.social.amazonMusic}`,
    `Goodreads author record: ${site.social.goodreads}`,
    `Open Library author record: ${site.social.openLibrary}`,
    `Amazon Author record: ${site.social.amazonAuthor}`,
    `MusicBrainz artist record: ${site.social.musicBrainz}`,
    `Deezer artist record: ${site.social.deezer}`,
    `Qobuz artist record: ${site.social.qobuz}`,
    `GitHub: ${site.social.github}`,
    "First Light MusicBrainz release: https://musicbrainz.org/release/c61ee5dc-87ef-4b82-b4cf-3e0443575cf7",
    "First Light Qobuz release: https://www.qobuz.com/us-en/album/first-light-keith-staggers/kw8pp8q9rai9p",
    "First Light Deezer release: https://www.deezer.com/us/album/1006478861",
    "",
    "# Services",
    "",
    ...serviceSections,
